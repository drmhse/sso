...
Maintainers track disclosure-safe remediation state using the
[vulnerability register](./docs/security/vulnerability-register.md). Sensitive
report details remain in the private advisory or incident record.
