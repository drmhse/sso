...
impl EncryptionService {
    ...
    pub(crate) fn from_keyring_values(
        active_key_id: &str,
        active_key_hex: &str,
        previous_keys: Option<&str>,
    ...
    #[cfg(test)]
    pub(crate) fn encrypt(&self, plaintext: &str) -> Result<Vec<u8>, EncryptionError> {
    ...
    #[cfg(test)]
    pub(crate) fn decrypt(&self, encrypted: &[u8]) -> Result<String, EncryptionError> {
    ...
    #[cfg(test)]
    pub(crate) fn rewrap(&self, encrypted: &[u8]) -> Result<Vec<u8>, EncryptionError> {
    ...
    #[cfg(test)]
    pub(crate) fn needs_rewrap(&self, encrypted: &[u8]) -> Result<bool, EncryptionError> {
