...
/// Default maximum number of organizations a single user can own
/// Can be overridden via MAX_ORGS_PER_USER environment variable
pub const DEFAULT_MAX_ORGS_PER_USER: u64 = 5;
