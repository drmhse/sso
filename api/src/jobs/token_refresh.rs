...
impl TokenRefreshJob {
    ...
    async fn refresh_single_token_locked(
        ...
        // 4. Reauthorize again after network I/O. A tenant suspended or user
    ...
    async fn load_current_authorized_identity(
        ...
        Self::load_authorized_identity_on(crate::store::DB::Conn(&self.db), identity_id).await
    }
    ...
    async fn resolve_oauth_credentials(
        ...
        use crate::store::{organization_oauth_credentials::OrganizationOAuthCredentialsStore, DB};
