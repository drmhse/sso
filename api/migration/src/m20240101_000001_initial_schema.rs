...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Users::IsPlatformOwner)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Identities::Provider)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new(Identities::EncryptionKeyId)
                            .string()
                            .default("default"),
                    )
                    ...
                    .col(
                        ColumnDef::new(Identities::LastRefreshedAt)
                            .date_time()
                            .null(),
                    )
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_identities_provider_user")
                    .table(Identities::Table)
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Sessions::RefreshTokenExpiresAt)
                            .date_time()
                            .null(),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(DeviceCodes::OrgSlug)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(DeviceCodes::ServiceSlug)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_device_codes_user")
                            .from(DeviceCodes::Table, DeviceCodes::UserId)
                            .to(Users::Table, Users::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(OauthStates::IsAdminFlow)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(OauthStates::Table, OauthStates::UserIdForLinking)
                            .to(Users::Table, Users::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_table(
                Table::create()
                    .table(TokenRefreshLocks::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(TokenRefreshLocks::UserId)
                            .string_len(36)
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(TokenRefreshLocks::AcquiredAt)
                            .date_time()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(TokenRefreshLocks::ExpiresAt)
                            .date_time()
                            .not_null(),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(MagicLinkTokens::UserId)
                            .string_len(36)
                            .null(),
                    )
                    .col(
                        ColumnDef::new(MagicLinkTokens::Email)
                            .string_len(254)
                            .not_null(),
                    )
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_magic_link_tokens_expires")
                    .table(MagicLinkTokens::Table)
        ...
        manager
            .create_table(
                Table::create()
                    .table(UserTotpSecrets::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(UserTotpSecrets::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(UserTotpSecrets::UserId)
                            .string_len(36)
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(UserTotpSecrets::SecretEncrypted)
                            .blob()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UserTotpSecrets::EncryptionKeyId)
                            .string()
                            .not_null()
                            .default("default"),
                    )
                    .col(
                        ColumnDef::new(UserTotpSecrets::Enabled)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    .col(
                        ColumnDef::new(UserTotpSecrets::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(UserTotpSecrets::EnabledAt)
                            .date_time()
                            .null(),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(UserTotpSecrets::Table, UserTotpSecrets::UserId)
                            .to(Users::Table, Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    .table(TotpBackupCodes::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(TotpBackupCodes::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(TotpBackupCodes::UserId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(TotpBackupCodes::CodeHash)
                            .string_len(191)
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(TotpBackupCodes::Used)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    .col(
                        ColumnDef::new(TotpBackupCodes::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(TotpBackupCodes::Table, TotpBackupCodes::UserId)
                            .to(Users::Table, Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(EmailVerificationTokens::Used)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(UserPasskeys::UserId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UserPasskeys::CredentialId)
                            .string_len(191)
                            .not_null()
                            .unique_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(UserPasskeys::Counter)
                            .big_integer()
                            .not_null()
                            .default(0),
                    )
                    ...
                    .col(
                        ColumnDef::new(UserPasskeys::Name)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UserPasskeys::BackupEligible)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    .col(
                        ColumnDef::new(UserPasskeys::BackupState)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    ...
                    .col(
                        ColumnDef::new(UserPasskeys::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
...
impl Migration {
    async fn create_organization_tables(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(OrganizationTiers::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(OrganizationTiers::Name)
                            .string_len(191)
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(OrganizationTiers::DisplayName)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationTiers::DefaultMaxServices)
                            .integer()
                            .not_null()
                            .default(2),
                    )
                    .col(
                        ColumnDef::new(OrganizationTiers::DefaultMaxUsers)
                            .integer()
                            .not_null()
                            .default(3),
                    )
                    ...
                    .col(
                        ColumnDef::new(OrganizationTiers::PriceCents)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(OrganizationTiers::Currency)
                            .string()
                            .not_null()
                            .default("usd"),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    .table(PlatformAuditLog::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(PlatformAuditLog::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(PlatformAuditLog::PlatformOwnerId)
                            .string()
                            .not_null(),
                    )
                    .col(ColumnDef::new(PlatformAuditLog::Action).string().not_null())
                    .col(
                        ColumnDef::new(PlatformAuditLog::TargetType)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(PlatformAuditLog::TargetId)
                            .string()
                            .not_null(),
                    )
                    .col(ColumnDef::new(PlatformAuditLog::Metadata).text())
                    .col(
                        ColumnDef::new(PlatformAuditLog::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_platform_audit_owner")
                            .from(PlatformAuditLog::Table, PlatformAuditLog::PlatformOwnerId)
                            .to(Users::Table, Users::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Organizations::SmtpEncryptionKeyId)
                            .string()
                            .default("default"),
                    )
                    .col(
                        ColumnDef::new(Organizations::CustomDomain)
                            .string_len(191)
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(Organizations::DomainVerified)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(Organizations::Table, Organizations::OwnerUserId)
                            .to(Users::Table, Users::Id),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_organizations_tier")
                            .from(Organizations::Table, Organizations::TierId)
                            .to(OrganizationTiers::Table, OrganizationTiers::Id),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_organizations_approved_by")
                            .from(Organizations::Table, Organizations::ApprovedBy)
                            .to(Users::Table, Users::Id),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_organizations_rejected_by")
                            .from(Organizations::Table, Organizations::RejectedBy)
                            .to(Users::Table, Users::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_memberships_org_user_unique")
                    .table(Memberships::Table)
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(OrganizationInvitations::OrgId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new(OrganizationInvitations::InvitedBy)
                            .string()
                            .not_null(),
                    )
                    .col(
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_org_invitations_inviter")
                            .from(
                                OrganizationInvitations::Table,
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_org_invitations_org_email_status_unique")
                    .table(OrganizationInvitations::Table)
                    .col(OrganizationInvitations::OrgId)
        ...
        manager
            .create_table(
                Table::create()
                    .table(OrganizationOauthCredentials::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(OrganizationOauthCredentials::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(OrganizationOauthCredentials::OrgId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationOauthCredentials::Provider)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationOauthCredentials::ClientId)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationOauthCredentials::ClientSecretEncrypted)
                            .blob()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationOauthCredentials::EncryptionKeyId)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationOauthCredentials::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(OrganizationOauthCredentials::UpdatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_org_oauth_creds_org")
                            .from(
                                OrganizationOauthCredentials::Table,
                                OrganizationOauthCredentials::OrgId,
                            )
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_org_oauth_creds_org_provider_unique")
                    .table(OrganizationOauthCredentials::Table)
                    .col(OrganizationOauthCredentials::OrgId)
                    .col(OrganizationOauthCredentials::Provider)
                    .unique()
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    .table(OrganizationAuditLog::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(OrganizationAuditLog::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(OrganizationAuditLog::OrgId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationAuditLog::ActorUserId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationAuditLog::Action)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationAuditLog::TargetType)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(OrganizationAuditLog::TargetId)
                            .string()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(OrganizationAuditLog::Success)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
                    ...
                    .col(
                        ColumnDef::new(OrganizationAuditLog::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_org_audit_org")
                            .from(OrganizationAuditLog::Table, OrganizationAuditLog::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_org_audit_actor")
                            .from(
                                OrganizationAuditLog::Table,
                                OrganizationAuditLog::ActorUserId,
                            )
                            .to(Users::Table, Users::Id),
                    )
                    .to_owned(),
    ...
    async fn create_service_tables(manager: &SchemaManager<'_>) -> Result<(), DbErr> {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Services::ClientId)
                            .string_len(191)
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(Services::ClientSecretHash)
                            .string()
                            .not_null()
                            .default(""),
                    )
                    ...
                    .col(
                        ColumnDef::new(Services::SamlEnabled)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    ...
                    .col(
                        ColumnDef::new(Services::SamlNameIdFormat)
                            .string()
                            .default("urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress"),
                    )
                    .col(ColumnDef::new(Services::SamlAttributeMapping).text())
                    .col(
                        ColumnDef::new(Services::SamlSignAssertions)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
                    .col(
                        ColumnDef::new(Services::SamlSignResponse)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_services_org")
                            .from(Services::Table, Services::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_services_org_slug_unique")
                    .table(Services::Table)
                    .col(Services::OrgId)
                    .col(Services::Slug)
                    .unique()
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_services_client")
                    .table(Services::Table)
                    .col(Services::ClientId)
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    .table(UpstreamProviders::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(UpstreamProviders::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(UpstreamProviders::OrgId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UpstreamProviders::ConnectionId)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UpstreamProviders::Name)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UpstreamProviders::ProviderType)
                            .string()
                            .not_null(),
                    )
                    .col(ColumnDef::new(UpstreamProviders::Issuer).string())
                    .col(
                        ColumnDef::new(UpstreamProviders::ClientId)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UpstreamProviders::ClientSecretEncrypted)
                            .blob()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UpstreamProviders::EncryptionKeyId)
                            .string()
                            .not_null()
                            .default("default"),
                    )
                    ...
                    .col(
                        ColumnDef::new(UpstreamProviders::Enabled)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
                    .col(
                        ColumnDef::new(UpstreamProviders::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(UpstreamProviders::UpdatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_upstream_providers_org")
                            .from(UpstreamProviders::Table, UpstreamProviders::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_upstream_providers_org_connection")
                    .table(UpstreamProviders::Table)
                    .col(UpstreamProviders::OrgId)
                    .col(UpstreamProviders::ConnectionId)
                    .unique()
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(VerifiedDomains::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(VerifiedDomains::OrgId)
                            .string_len(36)
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(VerifiedDomains::Verified)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    .col(
                        ColumnDef::new(VerifiedDomains::VerifiedAt)
                            .date_time()
                            .null(),
                    )
                    .col(
                        ColumnDef::new(VerifiedDomains::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(VerifiedDomains::UpdatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_verified_domains_org")
                            .from(VerifiedDomains::Table, VerifiedDomains::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_verified_domains_provider")
                            .from(VerifiedDomains::Table, VerifiedDomains::UpstreamProviderId)
                            .to(UpstreamProviders::Table, UpstreamProviders::Id)
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_verified_domains_domain")
                    .table(VerifiedDomains::Table)
                    .col(VerifiedDomains::Domain)
                    .unique()
                    .to_owned(),
            )
            .await?;
        manager
            .create_index(
                Index::create()
                    .name("idx_verified_domains_org")
                    .table(VerifiedDomains::Table)
                    .col(VerifiedDomains::OrgId)
                    .to_owned(),
            )
            .await?;
                ...
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(ApiKeys::Table, ApiKeys::CreatedBy)
                            .to(Users::Table, Users::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(
                        ColumnDef::new(SamlSigningKeys::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(SamlSigningKeys::ServiceId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(SamlSigningKeys::PrivateKeyEncrypted)
                            .blob()
                            .not_null(),
                    )
                    .col(ColumnDef::new(SamlSigningKeys::PublicKey).text().not_null())
                    .col(
                        ColumnDef::new(SamlSigningKeys::EncryptionKeyId)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(SamlSigningKeys::ValidFrom)
                            .date_time()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(SamlSigningKeys::ValidUntil)
                            .date_time()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(SamlSigningKeys::IsActive)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
                    .col(
                        ColumnDef::new(SamlSigningKeys::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            ...
                            .from(SamlSigningKeys::Table, SamlSigningKeys::ServiceId)
                            .to(Services::Table, Services::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    .table(SamlStates::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(SamlStates::StateId)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(SamlStates::ServiceId)
                            .string_len(36)
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(SamlStates::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_saml_states_service")
                            .from(SamlStates::Table, SamlStates::ServiceId)
                            .to(Services::Table, Services::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_saml_states_user")
                            .from(SamlStates::Table, SamlStates::UserId)
                            .to(Users::Table, Users::Id),
                    )
                    .to_owned(),
            )
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(ScimTokens::TokenHash)
                            .string_len(191)
                            .not_null()
                            .unique_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(ScimTokens::Active)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
                    ...
                    .col(
                        ColumnDef::new(ScimTokens::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_scim_tokens_org")
                            .from(ScimTokens::Table, ScimTokens::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_scim_tokens_creator")
                            .from(ScimTokens::Table, ScimTokens::CreatedBy)
                            .to(Users::Table, Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_plans_service")
                            .from(Plans::Table, Plans::ServiceId)
                            .to(Services::Table, Services::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_plans_service_name_unique")
                    .table(Plans::Table)
                    .col(Plans::ServiceId)
                    .col(Plans::Name)
                    .unique()
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Subscriptions::ServiceId)
                            .string_len(36)
                            .not_null(),
                    )
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_subscriptions_user_service_unique")
                    .table(Subscriptions::Table)
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_webhooks_org_name_unique")
                    .table(Webhooks::Table)
                    .col(Webhooks::OrgId)
                    .col(Webhooks::Name)
                    .unique()
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(WebhookDeliveries::Delivered)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
    ...
    async fn create_system_tables(
        ...
        manager
            .create_table(
                Table::create()
                    .table(MfaAuditLog::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(MfaAuditLog::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(MfaAuditLog::UserId)
                            .string_len(36)
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(MfaAuditLog::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_mfa_audit_user")
                            .from(MfaAuditLog::Table, MfaAuditLog::UserId)
                            .to(Users::Table, Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_mfa_audit_org_created")
                    .table(MfaAuditLog::Table)
                    .col(MfaAuditLog::OrgId)
                    .col(MfaAuditLog::CreatedAt)
                    .to_owned(),
            )
            .await?;
        manager
            .create_index(
                Index::create()
                    .name("idx_mfa_audit_user_created")
                    .table(MfaAuditLog::Table)
                    .col(MfaAuditLog::UserId)
                    .col(MfaAuditLog::CreatedAt)
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    .table(MfaDailyMetrics::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(MfaDailyMetrics::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(MfaDailyMetrics::Date)
                            .string_len(20)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::TotalUsers)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::MfaEnabledUsers)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::NewMfaSetups)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::MfaDisabled)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::TotpVerificationsTotal)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::TotpVerificationsSuccess)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::TotpVerificationsFailed)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::BackupCodesGenerated)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::BackupCodesUsed)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(MfaDailyMetrics::UpdatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_mfa_metrics_org")
                            .from(MfaDailyMetrics::Table, MfaDailyMetrics::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_mfa_metrics_org_date")
                    .table(MfaDailyMetrics::Table)
                    .col(MfaDailyMetrics::OrgId)
                    .col(MfaDailyMetrics::Date)
                    .unique()
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    .table(MfaFailurePatterns::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(MfaFailurePatterns::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(MfaFailurePatterns::FailureType)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(MfaFailurePatterns::FailureCount)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(MfaFailurePatterns::FirstSeenAt)
                            .date_time()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(MfaFailurePatterns::LastSeenAt)
                            .date_time()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(MfaFailurePatterns::IsSuspicious)
                            .boolean()
                            .not_null()
                            .default(false),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_mfa_failures_org")
                            .from(MfaFailurePatterns::Table, MfaFailurePatterns::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_mfa_failures_user")
                            .from(MfaFailurePatterns::Table, MfaFailurePatterns::UserId)
                            .to(Users::Table, Users::Id)
                            .on_delete(ForeignKeyAction::SetNull),
                    )
                    .to_owned(),
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_mfa_failures_org")
                    .table(MfaFailurePatterns::Table)
                    .col(MfaFailurePatterns::OrgId)
                    .to_owned(),
            )
            .await?;
        manager
            .create_index(
                Index::create()
                    .name("idx_mfa_failures_user_ip")
                    .table(MfaFailurePatterns::Table)
                    .col(MfaFailurePatterns::UserId)
                    .col(MfaFailurePatterns::IpAddress)
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    .table(MfaFeatureUsage::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(MfaFeatureUsage::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(MfaFeatureUsage::OrgId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(MfaFeatureUsage::UserId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(MfaFeatureUsage::FeatureType)
                            .string()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(MfaFeatureUsage::Timestamp)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    ...
                    .col(
                        ColumnDef::new(MfaFeatureUsage::Success)
                            .boolean()
                            .not_null(),
                    )
                    ...
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_mfa_feature_usage_org")
                            .from(MfaFeatureUsage::Table, MfaFeatureUsage::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_mfa_feature_usage_user")
                            .from(MfaFeatureUsage::Table, MfaFeatureUsage::UserId)
                            .to(Users::Table, Users::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_mfa_feature_usage_org")
                    .table(MfaFeatureUsage::Table)
                    .col(MfaFeatureUsage::OrgId)
                    .to_owned(),
            )
            .await?;
        manager
            .create_index(
                Index::create()
                    .name("idx_mfa_feature_usage_user")
                    .table(MfaFeatureUsage::Table)
                    .col(MfaFeatureUsage::UserId)
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(Permissions::Namespace)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Permissions::ObjectId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Permissions::Relation)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(Permissions::SubjectType)
                            .string_len(100)
                            .not_null(),
                    )
                    .col(
                    ...
                    .col(
                        ColumnDef::new(Permissions::SubjectRelation)
                            .string_len(100)
                            .null(),
                    )
                    .col(
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_permissions_check")
                    .table(Permissions::Table)
                    .col(Permissions::Namespace)
                    .col(Permissions::ObjectId)
                    .col(Permissions::Relation)
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_permissions_unique_tuple")
                    .table(Permissions::Table)
                    .col(Permissions::Namespace)
                    .col(Permissions::ObjectId)
                    .col(Permissions::Relation)
                    .col(Permissions::SubjectType)
                    .col(Permissions::SubjectId)
                    .col(Permissions::SubjectRelation)
                    .unique()
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(UserDevices::UserId)
                            .string_len(36)
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UserDevices::TrustTokenHash)
                            .string_len(191)
                            .not_null()
                            .unique_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(UserDevices::LastSeenAt)
                            .date_time()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UserDevices::ExpiresAt)
                            .date_time()
                            .not_null(),
                    )
                    .col(
                        ColumnDef::new(UserDevices::IsTrusted)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
        ...
        manager
            .create_table(
                Table::create()
                    .table(RiskRules::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(RiskRules::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    .col(
                        ColumnDef::new(RiskRules::OrgId)
                            .string_len(36)
                            .not_null()
                            .unique_key(),
                    )
                    .col(
                        ColumnDef::new(RiskRules::EnforcementMode)
                            .string()
                            .not_null()
                            .default("log_only"),
                    )
                    .col(
                        ColumnDef::new(RiskRules::LowThreshold)
                            .integer()
                            .not_null()
                            .default(30),
                    )
                    .col(
                        ColumnDef::new(RiskRules::MediumThreshold)
                            .integer()
                            .not_null()
                            .default(70),
                    )
                    .col(
                        ColumnDef::new(RiskRules::NewDeviceScore)
                            .integer()
                            .not_null()
                            .default(20),
                    )
                    .col(
                        ColumnDef::new(RiskRules::ImpossibleTravelScore)
                            .integer()
                            .not_null()
                            .default(50),
                    )
                    .col(
                        ColumnDef::new(RiskRules::VelocityThreshold)
                            .integer()
                            .not_null()
                            .default(10),
                    )
                    .col(
                        ColumnDef::new(RiskRules::VelocityScore)
                            .integer()
                            .not_null()
                            .default(30),
                    )
                    .col(
                        ColumnDef::new(RiskRules::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(RiskRules::UpdatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_risk_rules_org")
                            .from(RiskRules::Table, RiskRules::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_table(
                Table::create()
                    .table(SiemConfigs::Table)
                    .if_not_exists()
                    .col(
                        ColumnDef::new(SiemConfigs::Id)
                            .string()
                            .not_null()
                            .primary_key(),
                    )
                    ...
                    .col(
                        ColumnDef::new(SiemConfigs::Provider)
                            .string_len(100)
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(SiemConfigs::BatchSize)
                            .string()
                            .not_null()
                            .default("100"),
                    )
                    .col(
                        ColumnDef::new(SiemConfigs::Enabled)
                            .boolean()
                            .not_null()
                            .default(true),
                    )
                    .col(
                        ColumnDef::new(SiemConfigs::LastSuccessfulBatchAt)
                            .date_time()
                            .null(),
                    )
                    .col(
                        ColumnDef::new(SiemConfigs::LastProcessedLogId)
                            .string()
                            .null(),
                    )
                    .col(
                        ColumnDef::new(SiemConfigs::FailureCount)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(SiemConfigs::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(SiemConfigs::UpdatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .foreign_key(
                        ForeignKey::create()
                            .name("fk_siem_configs_org")
                            .from(SiemConfigs::Table, SiemConfigs::OrgId)
                            .to(Organizations::Table, Organizations::Id)
                            .on_delete(ForeignKeyAction::Cascade),
                    )
                    .to_owned(),
        ...
        manager
            .create_index(
                Index::create()
                    .name("idx_siem_configs_last_log")
                    .table(SiemConfigs::Table)
                    .col(SiemConfigs::LastProcessedLogId)
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(
                        ColumnDef::new(SystemJobs::Priority)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(SystemJobs::MaxRetries)
                            .integer()
                            .not_null()
                            .default(3),
                    )
                    .col(
                        ColumnDef::new(SystemJobs::AttemptCount)
                            .integer()
                            .not_null()
                            .default(0),
                    )
                    .col(
                        ColumnDef::new(SystemJobs::ScheduledFor)
                            .date_time()
                            .not_null(),
                    )
                    ...
                    .col(
                        ColumnDef::new(SystemJobs::CreatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
                    .col(
                        ColumnDef::new(SystemJobs::UpdatedAt)
                            .date_time()
                            .not_null()
                            .default(Expr::current_timestamp()),
                    )
            ...
            manager
                .create_table(
                    Table::create()
                        ...
                        .if_not_exists()
                        .col(
                            ColumnDef::new(DistributedLocks::LockKey)
                                .string()
                                .not_null()
                                .primary_key(),
                        )
                        .col(
                            ColumnDef::new(DistributedLocks::OwnerId)
                                .string()
                                .not_null(),
                        )
                        .col(
                            ColumnDef::new(DistributedLocks::AcquiredAt)
                                .date_time()
                                .not_null(),
                        )
                        .col(
...
#[derive(DeriveIden)]
enum OrganizationOauthCredentials {
    Table,
    Id,
    OrgId,
    Provider,
...
enum MfaDailyMetrics {
    ...
    NewMfaSetups,
    MfaDisabled,
    TotpVerificationsTotal,
    TotpVerificationsSuccess,
    TotpVerificationsFailed,
