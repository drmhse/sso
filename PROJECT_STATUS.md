...
| SQLite standalone bundles on Linux amd64/arm64 | **Beta, single-node.** `v0.8.3` includes the checksum-verifying installer; release attestations become evidence only after the coordinated workflow succeeds. No multi-writer or HA guarantee is made. |
