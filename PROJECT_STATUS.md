...
| Metrics, structured logs, and operational jobs | **Beta.** CI checks starter Prometheus rules and a Grafana dashboard; bounded local failure and capacity runners now have schema, safety, and redaction tests. Measured capacity, resource guidance, live monitoring import/firing, broader runtime redaction, and external failure-exercise evidence remain incomplete. |
