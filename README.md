...
- [Public claim audit](./PUBLIC_CLAIMS.md)
...
directory. The current map does not yet assign a license to every first-party
root, tooling, or embedded-client path; do not assume an unlisted path uses
either license. See [LICENSE](./LICENSE) for the authoritative repository map.
